...
SRC = my_add.c my_mul.c  my_div.c my_decimal_utils.c my_sub.c my_comparison.c my_truncate.c my_floor.c my_round.c  my_negate.c my_from_float_to_decimal.c my_from_decimal_to_float.c my_from_int_to_decimal.c    my_from_decimal_to_int.c  
