...
START_TEST(test_round_1) {
  ...
  int error_code = my_round(value, &my_result);
...
START_TEST(test_round_12) {
  ...
  my_decimal system_result = {
      {0xCCCCCD3E, 0x199999A5, 0x00000502, 0}};  // 23650570576955414727998
  my_decimal my_result;
...
START_TEST(test_round_14) {
  ...
  my_decimal system_result = {{10, 0, 0, 0}};   // 10
  my_decimal my_result;
...
START_TEST(test_round_22) {
  ...
  my_decimal system_result = {
      {0x24285C44, 0x01B2140C, 0, 0}};  // 122182182271212612
  my_decimal my_result;
...
Suite* suite_round(void) {
  Suite* suite = suite_create("my_round");
  TCase* tc_my_round;

  tc_my_round = tcase_create("tc_my_round");
  tcase_add_test(tc_my_round, test_round_1);
  tcase_add_test(tc_my_round, test_round_2);
  tcase_add_test(tc_my_round, test_round_3);
  tcase_add_test(tc_my_round, test_round_4);
  tcase_add_test(tc_my_round, test_round_5);
  tcase_add_test(tc_my_round, test_round_6);
  tcase_add_test(tc_my_round, test_round_7);
  tcase_add_test(tc_my_round, test_round_8);
  tcase_add_test(tc_my_round, test_round_9);
  tcase_add_test(tc_my_round, test_round_10);
  tcase_add_test(tc_my_round, test_round_11);
  tcase_add_test(tc_my_round, test_round_12);
  tcase_add_test(tc_my_round, test_round_13);
  tcase_add_test(tc_my_round, test_round_14);
  tcase_add_test(tc_my_round, test_round_15);
  tcase_add_test(tc_my_round, test_round_16);
  tcase_add_test(tc_my_round, test_round_17);
  tcase_add_test(tc_my_round, test_round_18);
  tcase_add_test(tc_my_round, test_round_19);
  tcase_add_test(tc_my_round, test_round_20);
  tcase_add_test(tc_my_round, test_round_21);
  tcase_add_test(tc_my_round, test_round_22);
  tcase_add_test(tc_my_round, test_round_23);
  tcase_add_test(tc_my_round, test_round_24);
  tcase_add_test(tc_my_round, test_round_25);
  tcase_add_test(tc_my_round, test_round_26);
  tcase_add_test(tc_my_round, test_round_27);

  suite_add_tcase(suite, tc_my_round);
